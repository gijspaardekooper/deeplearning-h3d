...
if __name__ == '__main__':
    ...
    for mode in modes:
        ...
        split_file = os.path.join(code_path, 'splits', 'h3d-dataset', '{0}_all.json'.format(mode))
        ...
        for ds,cat_det in train_split['scans'].items():
            ...
            for cat,shapes in cat_det.items():
                ...
                output = os.path.abspath(os.path.join(args.out_path, 'heads_processed'))
                ...
                for item,shape in enumerate(shapes):
                    ...
                    if not (args.skip and os.path.isfile(output_file + '.npy')):
                        ...
                        mesh = trimesh.load(os.path.join(source,shape) + '.obj')
